...
EVIDENCE="$SCRIPT_DIR/55-event-producer-local-integration-test.json"
MANIFEST="$SCRIPT_DIR/SHA256SUMS.event-producer-local-integration-test"
...
evidence = {
    "evidence_type": "canonflow_event_producer_local_integration_test",
    "evidence_version": 1,
    "contract_binding": {
