...
For every Beat materially integrating YD-CANON-0007 through YD-CANON-0011,
the Fact classification field must contain the exact classification
`human-approved-canon-amendment`. This exact marker must occur in the revised
Beat Sheet.

Do not repeat rejected countdown terminology anywhere in the output, including
in explanations, comparisons, revision notes, open questions, or compliance
sections. Describe only the new physically credible countdown progression.
""".strip()
