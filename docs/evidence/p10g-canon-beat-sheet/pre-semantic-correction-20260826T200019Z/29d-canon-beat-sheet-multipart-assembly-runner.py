...
SUCCESSFUL_PROVIDER_REQUEST_COUNT = 5
...
def assemble(root: Path) -> None:
    ...
    summary = {
        ...
        "transport": {
            ...
            "provider_request_count": (
                SUCCESSFUL_PROVIDER_REQUEST_COUNT
            ),
            "subdivided_part_numbers": [2],
        },
        "generation_input": {
    ...
    print(
        "Multipart provider calls: "
        f"{SUCCESSFUL_PROVIDER_REQUEST_COUNT}"
    )
    print("Database mutation: disabled")
    print("Automatic canon release: disabled")
    print("Human review required: True")
